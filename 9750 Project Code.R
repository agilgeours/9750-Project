...
bris07graph = ggplot(bris07, aes(Participant.ID, Antibody.Titer, color = Gender)) +
  ...
  theme(strip.text.x = element_blank(),
        plot.title = element_text(hjust = 0.5))
bris07graph
bris07graph + transition_time(Study.Time.Collected) +
...
uru07graph = ggplot(uru07, aes(Participant.ID, Antibody.Titer, color = Gender)) +
  ...
  theme(strip.text.x = element_blank(),
        plot.title = element_text(hjust = 0.5))
uru07graph
uru07graph + transition_time(Study.Time.Collected) +
...
bris08graph = ggplot(bris08, aes(Participant.ID, Antibody.Titer, color = Gender)) +
  ...
  theme(strip.text.x = element_blank(),
        plot.title = element_text(hjust = 0.5))
bris08graph
bris08graph + transition_time(Study.Time.Collected) +
...
memorycellsgraph
memorycellsgraph + transition_time(Study.Time.Collected) +
...
memorycellstotalgraph + transition_time(Study.Time.Collected) +
